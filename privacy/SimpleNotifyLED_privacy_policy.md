...
Notification contents are not uploaded to our servers.

## Local Settings

Profiles, colours, LED effects, edge lighting settings, quiet time settings, app exclusions, and other preferences are stored locally on your device.

These settings are not uploaded to our servers.
...
* Full-screen alert permission, to show the LED surface when the screen is off or on the always-on display.
* Overlay permission, as an optional fallback for drawing the LED over other apps.
* Wake lock permission, to help wake the screen into the LED surface on supported devices.

Permissions are used only for the app's notification LED features.
...
Google Play may process purchase, account, device, diagnostics, fraud prevention, and billing information according to Google's own privacy policy and Google Play terms.
...
This privacy policy may be updated from time to time. Updates will be posted in the same location as this policy.

## Contact

For privacy questions, contact:

xalies1983@gmail.com
